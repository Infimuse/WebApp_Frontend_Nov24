const experiences: Event[] = [
  ...
  },
  {
    ...
    description:
      "Learn how to make traditional Tagliatelle al Pesto with an Italian Master Chef. This hands-on class will teach you the secrets of making the perfect pasta and pesto from scratch. Enjoy your creation with a glass of wine and good company.",
    amenities: [
      "Ingredients Provided",
      "Recipe Book",
      "Certificate of Completion",
  ...
  // Sipping Hangouts
  {
    ...
    description:
      "Join us for an exclusive wine tasting event at our beautiful vineyard. Sample a variety of wines and learn about the winemaking process from our expert sommelier. Enjoy a guided tour of the vineyard and take home a complimentary bottle of wine.",
  ...
  // Kids Activities
  {
    ...
    description:
      "A fun and interactive cooking class designed for kids aged 5-12. Your little ones will learn basic cooking skills and create delicious dishes they can enjoy. All ingredients and materials are provided, and each child will receive a certificate of completion.",
  ...
  // Workshops
  {
    ...
    description:
      "Join our Photography Workshop and learn the art of capturing stunning images. Our expert photographer will guide you through various techniques and tips for both indoor and outdoor photography. Bring your own camera or use one of ours. Beginners are welcome.",
    amenities: [
      "Camera Provided",
      "Workshop Material",
      "Certificate of Completion",
  ...
  },
  {
    ...
    venue: "Tech Hub",
    description:
      "Learn the latest trends and strategies in digital marketing. This workshop covers SEO, social media marketing, and email campaigns. Perfect for entrepreneurs and marketing professionals looking to expand their skills.",
    amenities: [
      "Workshop Material",
      "Lunch Provided",
      "Certificate of Completion",
  ...
  },
  {
    ...
    venue: "Local Library",
    description:
      "Unleash your creativity with our Creative Writing Workshop. Learn to craft compelling stories and improve your writing skills. Ideal for aspiring writers and those looking to enhance their storytelling abilities.",
    amenities: [
      "Writing Materials",
      "Workshop Guide",
      "Certificate of Completion",
  ...
  },
  {
    ...
    venue: "City Hall",
    description:
      "Build confidence and improve your public speaking skills with our intensive workshop. Learn techniques for effective communication, speech writing, and presentation delivery. Ideal for professionals and students.",
  ...
  },
  {
    ...
    venue: "Art Gallery",
    description:
      "Discover the joy of painting with our hands-on workshop. Learn various painting techniques and create your own masterpiece. All materials provided, and no prior experience necessary.",
    amenities: [
      "Painting Supplies",
      "Workshop Guide",
      "Certificate of Completion",
  ...
  },
  {
    ...
    description:
      "Elevate your cooking skills with our Culinary Workshop. Learn from professional chefs and prepare gourmet dishes. Perfect for food enthusiasts and aspiring chefs.",
    amenities: [
      "Ingredients Provided",
      "Recipe Book",
      "Certificate of Completion",
  ...
  // Packages
  {
    ...
    venue: "Outdoor Park",
    description:
      "Join our intensive Fitness Bootcamp and achieve your fitness goals. Our trainers will guide you through various exercises designed to build strength and endurance. Suitable for all fitness levels.",
  ...
  },
  {
    ...
    description:
      "Escape the hustle and bustle of city life with our Yoga Retreat. Enjoy a weekend of relaxation, meditation, and yoga sessions led by experienced instructors. All meals and accommodations included.",
  ...
  },
  {
    ...
    description:
      "Pamper yourself with our Wellness Spa Weekend. Enjoy a range of spa treatments, including massages, facials, and body wraps. Relax in our luxurious facilities and unwind with yoga and meditation sessions.",
  ...
  },
  {
    ...
    venue: "National Park",
    description:
      "Explore the great outdoors with our Hiking and Camping Package. Enjoy guided hikes, campfire cooking, and stargazing. Perfect for nature enthusiasts and adventure seekers.",
  ...
  },
  {
    ...
    description:
      "Dive into adventure with our Scuba Diving Package. Experience the underwater world with guided dives, training sessions, and all equipment provided. Suitable for both beginners and experienced divers.",
  ...
  },
  {
    ...
    description:
      "Join our Photography Expedition and capture breathtaking landscapes. Learn advanced photography techniques from professionals and enjoy guided tours to scenic spots. Perfect for photography enthusiasts.",
  ...
  // More Learn a Skill
  {
    ...
    venue: "Music Academy",
    description:
      "Learn to play the guitar with our professional instructors. This course covers basic to advanced techniques, including chords, scales, and strumming patterns. Perfect for beginners and intermediate players.",
  ...
  },
  {
    ...
    description:
      "Learn to tackle common home repairs with confidence. Our experts will guide you through various DIY projects, including plumbing, electrical work, and carpentry. No prior experience required.",
    amenities: [
      "Tools Provided",
      "Workshop Guide",
      "Certificate of Completion",
  ...
  },
  {
    ...
    description:
      "Discover the basics of gardening with our beginner-friendly course. Learn about soil preparation, planting techniques, and garden maintenance. Perfect for those looking to start their own garden.",
  ...
  // More Unique Experiences
  {
    ...
    venue: "Open Fields",
    description:
      "Experience the thrill of a hot air balloon ride. Enjoy breathtaking views from above and capture stunning photos. A perfect adventure for thrill-seekers and nature lovers.",
    amenities: [
      "Balloon Ride",
  ...
  },
  {
    ...
    venue: "Coral Reef",
    description:
      "Dive into the depths of the ocean with our Scuba Diving Adventure. Explore coral reefs, shipwrecks, and marine life. All equipment and training provided.",
  ...
  },
  {
    ...
    venue: "Helipad",
    description:
      "Take to the skies with our Helicopter Tour. Enjoy panoramic views of the city and its landmarks. Perfect for special occasions and sightseeing.",
    amenities: [
      "Helicopter Ride",
      "Complimentary Photos",
      "Certificate of Completion",
  ...
  // More Practice
  {
    ...
    description:
      "Find inner peace with our Meditation Classes. Learn various meditation techniques to reduce stress and improve mental clarity. Suitable for all experience levels.",
    amenities: [
      "Meditation Mats",
      "Workshop Material",
      "Certificate of Completion",
  ...
  },
  {
    ...
    description:
      "Enhance your yoga practice with our Advanced Yoga classes. Learn advanced poses, breathing techniques, and meditation. Suitable for experienced yoga practitioners.",
  ...
  },
  {
    ...
    venue: "CrossFit Gym",
    description:
      "Challenge yourself with our CrossFit Training program. Our certified trainers will push you to your limits with high-intensity workouts. Perfect for fitness enthusiasts looking to take their training to the next level.",
