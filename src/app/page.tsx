...
//             <div
//               ref={ExploreRef}
//               className="sm:flex grid grid-cols-1 gap-y-3 overflow-x-auto space-x-10 pb-4 hide-scrollbar"
//             >
...
//             <div
//               ref={ExploreRef}
//               className="flex space-x-10 overflow-x-auto pb-4 hide-scrollbar"
//             >
...
//         <section className="relative mb-8 max-w-[1240px] mx-auto">
//           <div className="hidden sm:flex space-x-10 justify-between items-center mb-4">
//             <div>
...
//           <div
//             ref={workshopsRef}
//             className="grid grid-cols-1 gap-y-3 sm:flex space-x-10 overflow-x-auto pb-4 hide-scrollbar"
//           >
...
//         <section className="relative mb-8 max-w-[1240px] mx-auto">
//           <div className="hidden sm:flex space-x-10 justify-between items-center mb-4 hide-scrollbar">
//             <div>
...
//             className="grid grid-cols-1 sm:flex w-full space-x-10 overflow-x-auto pb-4 hide-scrollbar"
//           >
