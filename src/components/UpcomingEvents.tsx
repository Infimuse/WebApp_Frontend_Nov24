  ...
  return (
    <div className="relative sm:hidden px-4 w-full overflow-hidden">
      ...
      >
        ...
        {
          events.length < 1 && <p className="text-center text-black p-4 text-xs flex flex-col justify-center items-center gap-2 font-semibold w-full">
            <IoWarningOutline size={25} color="#bb2460"/>
            No events here yet!</p>
        }
      </div>
    </div>
  );
