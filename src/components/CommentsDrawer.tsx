            ...
            <div className="p-4 border-t mt-auto">
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="Add a comment..."
                  className="flex-1 px-3 py-2 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-[#BB2460]"
                  style={{ fontSize: "16px" }} // Ensures iOS doesn't zoom in
                />
                <button
                  className="px-4 py-2 bg-[#BB2460] text-white rounded-lg"
                  style={{ fontSize: "16px" }} // Matches input font size
                >
                  Post
                </button>
              </div>
