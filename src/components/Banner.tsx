...
const backgroundImage2 =
  "https://infimuse.s3.amazonaws.com/groupExperience.jpeg";
...
const banners = [
  ...
  },
  {
    ...
    subtitle:
      "Learn new things, Connect with People and get your creative juices flowing",
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 sm:px-10 md:px-20">
          ...
          <button
            className={`font-bold py-2 px-4 sm:px-6  shadow-lg hover:shadow-xl transition-all duration-300 rounded-full ${
              banners[currentBanner].buttonText === "Communities"
                ? "bg-rainbow-gradient"
                : "bg-[#12B9f3] hover:bg-pink-700"
            } text-white`}
          >
